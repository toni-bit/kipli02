...
echo color("nevy","# # # # # # # # # # # # # # # # # # # # # # # # \n");
echo color("blue","[•]          PUNTENT-01 COMPANY      \n");
echo color("nevy","# # # # # # # # # # # # # # # # # # # # # # # # \n");
...
function change(){
        ...
        echo color("green","+] SANGAR CUK DADI LO");
        ...
        gofood:
        echo "\n".color("yellow","!] Claim duwek panas ");
        echo "\n".color("yellow","!] Seng sabar");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        echo "\n".color("red","-] Message: ".$message);
        goca:
        echo "\n".color("yellow","!] Voucher ngepet ");
        echo "\n".color("yellow","!] ojok seneng sek");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        echo "\n".color("red","-] Message: ".$message);
        gocar:
        echo "\n".color("yellow","!] Claim utangan ");
        echo "\n".color("yellow","!] bismilah sek ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        $expired6 = getStr1('"expiry_date":"','"',$cekvoucher,'6');
         setpin:
         echo "\n".color("nevy","?] Gae Pin Ta gak?: y/n ");
         $pilih1 = trim(fgets(STDIN));
         if($pilih1 == "y" || $pilih1 == "Y"){
         //if($pilih1 == "y" && strpos($no, "628")){
         echo color("red","==========( PIN ANDA = 114111 )==========")."\n";
         $data2 = '{"pin":"114111"}';
         ...
         echo color("red","-] Otpne slh mbot seng fokus");
         echo"\n======================================\n\n";
         echo color("yellow","!] Silahkan input kembali\n");
         goto otp;
         }
         }else{
         echo color("red","Goblok Wes Kedaftar cok!!!");
         echo "\nMau ulang? (y/n): ";
